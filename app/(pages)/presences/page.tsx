...
export default function PresenceClient({ userId }: { userId: string }) {
    ...
    const loadPresences = async () => {
        try {
            ...
            // 🔹 Mapper les présences avec les ids nécessaires
            const mappedPresences: Presence[] = data.map((p) => ({
                ...
                filiereId: (p as any).filiereId,        // 👈 Important pour update
                sessionId: (p as any).sessionId,        // 👈 Important pour update
                anneeId: (p as any).anneeAcademiqueId,  // 👈 Important pour update
