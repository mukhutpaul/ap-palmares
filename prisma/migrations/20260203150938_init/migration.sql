/*
  ...
  - Added the required column `postnom` to the `Etudiant` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Etudiant" ("classeId", "createdAt", "createdById", "email", "id", "nom", "prenom") SELECT "classeId", "createdAt", "createdById", "email", "id", "nom", "prenom" FROM "Etudiant";
DROP TABLE "Etudiant";
